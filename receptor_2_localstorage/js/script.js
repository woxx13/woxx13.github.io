...
//Блокируем все кнопки, кроме "off"		
		...
		set('console_batcher_1_text', 'Идет дозирование!');
		set('console_batcher_2_text', 'Идет дозирование!');
		set('console_mixer_1_text', 'Идет дозирование!');
			...
			{           
				...
				{    
					...
					else
					{
						...
						//alert("Опорожнение дозатора 1 закончено!");
						unloading_2();
					}
				}, timer)
			}
